...
class CustomTextField: UITextField {
    ...
    convenience init(placeholder: String, isSecure: Bool = false) {
        ...
        attributedPlaceholder = NSAttributedString(string: placeholder, attributes: [NSAttributedString.Key.foregroundColor: UIColor.customGray, NSAttributedString.Key.font: UIFont(name: "HelveticaNeue-Bold", size: 22)])
        setup()
    }
    ...
    private func setupErrorLabel() {
        ...
        errorLabel.font = UIFont(name: "HelveticaNeue-Bold", size: 22)
